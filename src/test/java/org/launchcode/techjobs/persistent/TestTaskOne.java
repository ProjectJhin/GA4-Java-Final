...
public class TestTaskOne extends AbstractTest{
    ...
    * */
    ...
    public void testDbConnectionProperties () throws IOException {
        ...
        Pattern urlPattern = Pattern.compile("spring.datasource.url=jdbc:mysql://localhost:3306/test");
        ...
        Pattern usernamePattern = Pattern.compile("spring.datasource.username=test");
        ...
        Pattern passwordPattern = Pattern.compile("spring.datasource.password=test");
